...
#Creating task frame
task_frame=Frame(root, borderwidth=1, relief=RAISED)
#task_frame.grid(row=1, column=0, sticky=W)

task_title=Label(task_frame, text='Task', font=('Verdana', 12))
...
# Data Frame *****************************************************
data_frame=Frame(root, borderwidth=1, relief=RAISED)
#data_frame.grid(row=2, column=0, sticky=N+S+E+W)

# ??? Existing dataset ???
data_title=Label(data_frame, text='Data type', font=('Verdana', 12))
...
#Filter Frame ****************************************************
filter_frame=Frame(root, borderwidth=1, relief=RAISED)

filter_title=Label(filter_frame, text='Filter', font=('Verdana', 12))
...
#Kernel Frame ****************************************************
kernel_frame=Frame(root, borderwidth=1, relief=RAISED)

kernel_title=Label(kernel_frame, text='Kernel', font=('Verdana', 12))
...
#Learning Frame *************************************************
learning_frame=Frame(root, borderwidth=1, relief=RAISED)

learning_title=Label(learning_frame, text='Learning', font=('Verdana', 12))
...
results_title=Label(results_frame, text='Results', font=('Verdana', 12))
...
#Eplot_frame Frame **************************************************
eplot_frame=Frame(root, borderwidth=1, relief=RAISED)
...
#Plot Frame *****************************************************
plot_frame=Frame(root, borderwidth=1, relief=RAISED)

#plot_title=Label(plot_frame, text='Plot', font=('Verdana', 12))
...
# Run Frame ***************************************************
run_frame=Frame(root, borderwidth=1, relief=RAISED)
...
eplot_xlabel=Label(run_frame, text=eplot_xlabel_t)
eplot_xlabel.grid(row=1, column=0, sticky=N+S+E+W)

check_v_logx=IntVar()

ax_logx_check=Checkbutton(run_frame, text='Logaritmic x-axis', variable=check_v_logx)
check_v_logx.set(0)
ax_logx_check.grid(row=0, column=0, sticky=N+S+E+W)

run_but=Button(run_frame, text='Run', command=button_push)
run_but.grid(row=2, column=0, sticky=N+S+W+E)

# Placement ****************************************************
for root_cols in range(10):
  Grid.columnconfigure(root, root_cols, weight=1)
for root_rows in range(10):
  Grid.rowconfigure(root, root_rows, weight=1)


task_frame.grid(row=0, column=0, padx=1, pady=1, sticky=N+S+E+W)
data_frame.grid(row=1, column=0,padx=1, pady=1, sticky=N+S+E+W)
filter_frame.grid(row=2, column=0,padx=1, pady=1, sticky=N+S+E+W)
kernel_frame.grid(row=3, column=0,padx=1, pady=1, sticky=N+S+E+W)
learning_frame.grid(rowspan=2, row=0, column=1,padx=1, pady=1, sticky=N+S+E+W)
results_frame.grid(rowspan=2, row=2, column=1, padx=1, pady=1, sticky=N+S+E+W)
eplot_frame.grid(rowspan=3, row=0, column=2, padx=1, pady=1, sticky=N+S+E+W)
plot_frame.grid(row=5, columnspan=3, padx=1, pady=1, sticky=N+S+E+W)
run_frame.grid(row=3, column=2, padx=1, pady=1, sticky=N+S+E+W)
...
#Run Frame
for run_cols in range(10):
  Grid.columnconfigure(run_frame, run_cols, weight=1)
for run_rows in range(10):
  Grid.rowconfigure(run_frame, run_rows, weight=1)
  
# *****************************************************************
# def onsize(event):
#     print(plot_frame.winfo_width(), plot_frame.winfo_height())
#     main_plot.config(figsize(plot_frame.winfo_width(), plot_frame.winfo_height()))
#     #canvas.get_tk_widget.config(width=plot_frame.winfo_width(), height=plot_frame.winfo_width())
